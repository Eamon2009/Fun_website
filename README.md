...
* **Zero-Lag Canvas:** Optimized using `requestAnimationFrame` for 60FPS performance.
...
* **Trigonometric Logic:** Calculating `Math.atan2` and `sin/cos` for smooth segment rotation.
...
3.  **Move your mouse**—the bugs are faster than they look!
